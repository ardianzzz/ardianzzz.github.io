	...
	if ( 'querySelector' in document && 'addEventListener' in window && Array.prototype.forEach ) {
		...
		Array.prototype.forEach.call(sliders, function (slider, index) {
			...
			var createNavButtons = function () {
				if ( slideNav !== null ) {
					slideNav.innerHTML = '<a data-slider-nav-prev href="#" class="slider-prev-arrow">Previous</a> <a data-slider-nav-next href="#" class="slider-neaxt-arrow">Next</a>';
				}
			};
...
$('.meta-tools .love').click(function() {
