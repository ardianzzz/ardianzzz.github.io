...
var config = {
    ...
    onRemoteStream: function(media) {
        ...
        var zxc = document.createElement('div');
    ...
    onRoomFound: function(room) {
        ...
        tr.innerHTML = '<div>' + room.roomName + '</div>' +
            '<button class="join" id="' + room.roomToken + '">Join Room</button>';
...
var online = document.getElementById("online") || document.body;
